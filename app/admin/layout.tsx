  ...
  return (
    <div className="flex min-h-screen bg-[#F6F7FB] dark:bg-slate-950 transition-colors">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {/* Header / Top Bar */}
        <header className="h-20 bg-white dark:bg-slate-900 border-b dark:border-slate-800 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-40 backdrop-blur-md bg-white/80 dark:bg-slate-900/80">
