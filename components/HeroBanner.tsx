      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative flex justify-center items-center h-full">
            ...
            <div ref={imageRef} className="relative w-full max-w-[300px] lg:max-w-[420px] will-change-transform">
              <Image 
                key={banner.imageUrl} 
                src={banner.imageUrl} 
              ...
              {banner.offTagText && (
                <div className="absolute top-2 right-2 sm:top-0 sm:right-0 text-white w-[70px] h-[70px] md:w-[85px] md:h-[85px] flex flex-col items-center justify-center text-center font-bold font-lato">
                    <Image src='/images/discount-badge.png' className="w-full h-full" alt="Discount Badge" width={85} height={85} />
                  <span className="text-lg md:text-xl leading-none block relative -top-15">{banner.offTagText}%</span>
                  <span className="text-lg md:text-xl leading-none block relative -top-15">off</span>
                </div>
              )}
            </div>
          </div>
